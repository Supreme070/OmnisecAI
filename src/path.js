...
export const ADMIN_PATH = 'https://app.omnisecai.com/';
export const BUY_NOW_URL = 'https://omnisecai.com/enterprise';
export const FREEBIES_URL = 'https://github.com/omnisecai';
export const DOCS_URL = 'https://docs.omnisecai.com';
