    ...
    <Stack direction={{ sm: 'row' }} sx={{ gap: 1.5, justifyContent: 'space-between', alignItems: { xs: 'flex-start', sm: 'center' } }}>
      <Stack sx={{ gap: 1 }}>
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          OmnisecAI offers enterprise-grade AI security solutions, empowering you to protect your AI models and LLM infrastructure.
        </Typography>
      </Stack>
      <Button
        variant="contained"
    ...
    <Stack sx={{ alignItems: 'flex-start', gap: 3, height: 1, justifyContent: 'center' }}>
      <Stack sx={{ gap: 1 }}>
        <Stack sx={{ alignItems: 'flex-start', gap: 1.5 }}>
          <Chip
            label={<Typography variant="subtitle2">OmnisecAI Dashboard</Typography>}
            icon={
              <CardMedia
                component="img"
                image="/assets/images/shared/celebration.svg"
    ...
    menuItems: [
      {
        title: 'General',
        itemsList: [
          { title: 'About', link: { href: '/about', ...linkProps } },
      ...
      },
      {
        title: 'External',
        itemsList: [
          { title: 'Blog', link: { href: 'https://blog.omnisecai.com/', ...linkProps } },
