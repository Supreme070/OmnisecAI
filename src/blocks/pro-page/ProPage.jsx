        ...
        >
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Typography variant="body1" color="textSecondary" sx={{ mb: 3, color: 'grey.700', textAlign: 'center' }}>
              <Link href="https://omnisecai.com/enterprise" target="_blank" underline="hover" component={NextLink}>
                Check out OmnisecAI Enterprise
              </Link>{' '}
              which offers advanced features, dedicated support, and comprehensive security capabilities.
            </Typography>
