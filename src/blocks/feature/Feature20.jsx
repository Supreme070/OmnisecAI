 ...
 *
 * Demos:
 * - [Feature20](https://omnisecai.com/blocks/feature/feature20)
 *
 * API
 * - [Feature20 API](https://docs.omnisecai.com/ui-kit/components/feature/feature20)
 */
                        ...
                        >
                          <SvgIcon
                            {...(typeof item.icon === 'string'
                              ? { name: item.icon, color: '#FFCC00', size: 28, stroke: 1.5 }
                              : { size: 28, stroke: 1.5, color: '#FFCC00', ...item.icon }
                            )}
                          />
                        </motion.div>
                      </Avatar>
