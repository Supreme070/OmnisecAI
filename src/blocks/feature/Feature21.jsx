...
import { ThreatIntelligenceMockup } from '@/components/3d';
 ...
 *
 * Demos:
 * - [Feature21](https://omnisecai.com/blocks/feature/feature21)
 *
 * API
 * - [Feature21 API](https://docs.omnisecai.com/ui-kit/components/feature/feature21)
 */

export default function Feature21({ heading, caption, image, mockupType, features, primaryBtn, secondaryBtn }) {
          ...
          {(image || mockupType) && (
            ...
            >
              <GraphicsCard>
                <Box
                  sx={{
                    pl: mockupType ? 0 : imagePadding,
                    pt: mockupType ? 0 : imagePadding,
                ...
                >
                  {mockupType === 'threat-intelligence' ? (
                    <Box
                      sx={{
                        transform: { xs: 'scale(0.42)', sm: 'scale(0.52)', md: 'scale(0.58)' },
                        transformOrigin: 'center center',
                      }}
                    >
                      <ThreatIntelligenceMockup scale={1} />
                    </Box>
                  ) : (
                    <GraphicsImage
                      image={image}
              ...
              {secondaryBtn && (
                ...
                >
                  <ButtonAnimationWrapper>
                    <Button variant="outlined" startIcon={<SvgIcon name="tabler-eye" size={16} stroke={3} color="inherit" />} {...secondaryBtn} />
                  </ButtonAnimationWrapper>
                </motion.div>
              )}
              {primaryBtn && (
